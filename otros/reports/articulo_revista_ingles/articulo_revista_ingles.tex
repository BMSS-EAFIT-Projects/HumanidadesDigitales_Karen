...
\usepackage{microtype} % Mejora el espaciado
\setlength{\emergencystretch}{3em} % Permite más flexibilidad

% --- Metadatos ---
\title{Science in the Colombian Public Sphere:  \\
...
\author{
	...
	\small \texttt{kmgomezm@eafit.edu.co}
	\and
	Biviana Marcela Suárez-Sierra\\ 
	\small Universidad EAFIT, Medellín, Colombia\\
	\small \texttt{bmsuarezs@eafit.edu.co}
}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{figures/accuracy_umbral.png}
...
At the document level, 4\,154 columns contain at least one effective mention of science, corresponding to 30.4\% of the total number of analyzed columns. Table~\ref{tab:res_fragmentos_subcategoria} presents the distribution of fragments classified as scientific mentions across the 17 categories of the UNESCO Thesaurus.
	...
	%Below are some examples of the selected fragments. These were translated by the authors from Spanish (the original language) into English. They will be available in their original language in the supplementary material.
	
	%From the category Science and research management:
	
	%\begin{quote}
	%	(...) separately. The Ministry of Science, Technology and Innovation bears the responsibility of convening the formation of a National Innovation System whose purpose is to develop the roadmap set forth by the Mission of Sages, aligning all actors at the local, regional and national levels. Knowledge is always a collective achievement. Faced with the challenges we confront as a country, it is necessary that we collectively assume, all actors together, the challenge of managing knowledge, learning continuously, in order to place it at the service of communities. To overcome the crisis and achieve structural transformations, planning and medium- to long-term work are required, where everyone contributes without thinking only of immediate gains. A system in which art, the humanities, technology, and the social and exact sciences, as expressions of knowledge, become part of the daily life of Colombians demands that we stop acting (...)
		
	%	- \cite{montoya2020conocimiento} [fragment translated by the authors].
	%\end{quote}
	
	%From the category Environmental sciences and engineering:
	%\begin{quote}
	%	(...) environmental and climate justice. 4. Articulate sustainable development goals and the post-conflict 2030 agenda, focusing on renewable energy, multimodal transport, green building, permaculture, self-consumption, and resilient water territories. 5. Redefine the urban-rural relationship, emphasizing ecosystem restoration and conservation, equity, solidarity, shared responsibility, and identity. 6. Review the mining and energy model, adjusting it to environmental land use planning, refrain from building new hydroelectric megaprojects, reject the use of fracking, and transition to alternative renewable energies. 7. Promote comprehensive education and the democratization of information and knowledge as instruments for peacebuilding, respecting utopias and cultural and natural diversity. 8. Strengthen scientific research, innovation, and other modes of knowledge construction as means to improve understanding of ecological, climatic, and cultural realities. 9. Recognize nature as a victim of the armed conflict and the Colombian development model, and, for (...)
	%	- \cite{ruiz2018siambiental} [fragment translated by the authors].
	%\end{quote}
	
	%From the category Mathematics and statistics:
	%\begin{quote}
	%	(...) science aspires to economic models, to reducing everything to a small theoretical body from which its basic corollaries can be deduced directly. In mathematics, for example, a short, arithmetic proof is more beautiful than a longer one that must resort to calculation to prove the same thing. All geometries are developed from a handful of elementary postulates. Physicists dream of the Theory of Everything; they are tired of dealing with that swarm of cloying particles. That's not elegant! In science, as in art, beauty lies in brevity and simplicity, even if there is always a secret complexity hidden between the folds. Yes, I will devote the best of my days to the search for the mother fragrance, and when I find it, I will bottle it in a small jar that will be a discreet gem, of course, and I will place it at my wife's feet, I promise. The rest will be (...)
	%	- \cite{londono2019fraganciamadre} [fragment translated by the authors].
	%\end{quote}
...
\subsection{Descriptive and Exploratory Analyses}
	...
	\begin{table}[H]
		...
		\begin{tabular}{l c}
			...
			Number of unique words (total vocabulary) & 283923\\
			\hline
		\end{tabular}
	\end{table}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{0.48\textwidth}
			...
			\caption{Word cloud, fragments tagged as science.}
			\label{fig:nube_ciencia}
		\end{subfigure}
		\caption{Word clouds to compare predominant vocabulary in the general corpus versus the subcorpus.}
...
The ten most frequent entities by class (Person, Organization, and Location) are presented below, considering only those whose occurrence exceeds 30\% of the subcorpus of fragments with effective mentions of science. This criterion makes it possible to focus the analysis on the actors, institutions, and geographic spaces with the greatest centrality in the scientific discourse of opinion columns.
	...
	\begin{table}[H]
		\centering
		\caption{Comparative frequency of characters in the general corpus vs. the scientific corpus.}
		\label{tab:ents_per}
		\footnotesize 
		...
		\begin{tabular}{p{3cm}P{2.2cm}P{2.2cm}P{2.2cm}p{5cm}}
			...
			\textbf{Corpus Freq.} & 
			\textbf{Science Freq.} & 
			\textbf{\% Science/ Corpus} & 
			\textbf{Description} \\
			\midrule
			Humboldt & 63 & 23 & 36 & German naturalist, geographer and explorer, 18th and 19th centuries. \\
			Newton & 25 & 9 & 36 & English physicist, 17th and 18th centuries. \\
			Stephen Hawking & 41 & 16 & 39 & British scientist and science communicator, 20th and 21st centuries. \\
			Charles Darwin & 25 & 11 & 44 & English naturalist, 19th century. \\
			Greta Thunberg & 50 & 16 & 32 & Swedish environmental activist, 21st century. \\
			Ricardo Lozano & 15 & 7 & 46 & Geologist and former Minister of Environment and Sustainable Development of Colombia (2018). \\
			Mabel Torres & 13 & 7 & 53 & Colombian scientist and former Minister of Science, Technology and Innovation of Colombia (2020). \\
			Wade Davis & 12 & 4 & 33 & Canadian-Colombian scientist. \\
			Dolly Montoya Castaño & 12 & 4 & 33 & Colombian scientist and former rector of the National University of Colombia. \\
			Carl Sagan & 10 & 5 & 50 & American astronomer, astrophysicist and science communicator, 20th century.\\
	...
	\begin{table}[H]
		...
		\begin{tabular}{p{3cm}P{2.2cm}P{2.2cm}P{2.2cm}p{5cm}}
			...
			\textbf{Description} \\
			\midrule
			OECD & 296 & 86 & 30 & Organisation for Economic Co-operation and Development, international organization. \\
			Universidad Pedagógica Nacional & 117 & 55 & 47 & Public university in Colombia. \\
			...
			University of Massachusetts Amherst & 49 & 21 & 42 & Public university and research center in the United States, located in Amherst, Massachusetts. \\
			Finagro & 44 & 15 & 34 & Fund for the financing of the agricultural sector, financial organization in Colombia. \\
	...
	\begin{table}[H]
		\centering
		\caption{Comparative frequency of geographic locations in the general corpus vs. the scientific corpus.}
		\label{tab:ents_loc}
		\footnotesize 
		\begin{tabular}{p{3cm}P{2.2cm}P{2.2cm}P{2.2cm}p{5cm}}
			\toprule
			...
			\textbf{Science Freq.} & 
			\textbf{\% Science/Corpus} & 
			\textbf{Description/Context} \\
			\midrule
			Amazonia & 306 & 112 & 37.21 & Biogeographic region encompassing the tropical rainforest of the Amazon basin in South America. \\
			Hidroituango & 127 & 46 & 36.22 & Hydroelectric project in Antioquia, Colombia, on the Cauca River. \\
			Cauca River & 93 & 33 & 32.58 & Second most important river in Colombia, traversing the Andean region. \\
			Orinoquia & 40 & 14 & 35.00 & Natural region of Colombia and Venezuela, also known as the Eastern Plains. \\
			Bogotá River & 31 & 16 & 51.61 & River crossing the Bogotá savanna, facing significant pollution issues. \\
			Sabana & 28 & 13 & 46.43 & Reference to the Bogotá Savanna, a high plateau in the Eastern Cordillera. \\
			Parques Nacionales Naturales (PNN) & 35 & 15 & 33.33 & Colombia's system of protected areas, under the jurisdiction of the Ministry of Environment. \\
			Caribbean Sea & 20 & 7 & 35.00 & Tropical open sea of the Atlantic Ocean, bordering the northern coast of Colombia. \\
			Mocoa & 18 & 9 & 50.00 & Capital city of the department of Putumayo, Colombia, in the Amazon region. \\
			\bottomrule
		\end{tabular}
	\end{table}
...
Initially, this topic modeling exercise was performed on the entire corpus, with the aim of characterizing the general thematic structure of the opinion columns before focusing the analysis on the science subcorpus. To do this, the model was run by varying the parameter \textit{num\_topics}, which defines the maximum number of topics that can be estimated. Each parameter setting produces a different model, understood here as a specific semantic grouping structure in which the fragments of the corpus are distributed across a given set of latent topics.

 For each estimated model, the coherence metric 
 $c_v$ was calculated, which evaluates the
 degree of internal semantic consistency of the most representative terms for each topic. In
 general terms, higher coherence values indicate that the words defining a topic tend to co-occur
 in the corpus, which is usually associated with greater interpretability from a human perspective.
 Reporting the results for different configurations allows us to compare the thematic quality
 of the models and justify the selection of the most appropriate number of topics. The results
 obtained are presented in Table~\ref{tab:coherence_topics}.

\begin{table}[H]
	\centering
	\caption{Results of topic modeling for different values of the parameter \textit{num\_topics}.}
	\begin{tabular}{ccccc}
		\hline
...
The number of final topics is one less than the value initially defined by the parameter, since applying the reduction of outliers eliminates the topic that groups together documents considered atypical. It can be seen that, in general, as the maximum number of topics increases, the coherence value tends to increase, suggesting greater semantic homogeneity within each grouping. In particular, when the model automatically determines the number of topics, 63 final topics are obtained and the highest coherence value among the configurations evaluated.

		
Maintaining the 63-topic model, Table \ref{tab:bertopic_coherence_top} presents the 10 topics with the highest percentage of grouped documents, along with the coherence value calculated for each one and their respective representative words. Together, these 10 topics account for 70\% of the fragments analyzed.
		
\begin{table}[H]
	\centering
	\small
	\caption{Top BERTopic topics with per-topic coherence ($c_v$), percentage of documents, and representative keywords.}
	\begin{tabularx}{\textwidth}{c c c X}
		...
		4  & 0.8427 & 3.34  & women, woman, men, sexual, violence, gender, sex, feminism, harassment, sexual \\
...
\end{table}
		...
		The same procedure was applied to fragments classified as references to science. 
		
		\begin{table}[H]
			\centering
			\caption{BERTopic results for different values of \texttt{num\_topics}, specifically science.}
		...
		In this case, the best model among those evaluated was the one with 20 topics, according to the metric used. For this model, the results are presented in Table \ref{tab:topics_ciencia}. Likewise, it can be observed that 90\% of the documents were concentrated in the first 10 topics, indicating a high thematic concentration in a small subset of topics.
		
		\begin{table}[H]
			\centering
			\small
			\caption{Top BERTopic topics with per-topic coherence ($c_v$), percentage of documents, and representative keywords, specific to mentions of science.}
			\begin{tabularx}{\textwidth}{c c c X}
				\hline
				\textbf{Topic} & \textbf{Coherence ($c_v$)} & \textbf{Percentage (\%)} & \textbf{Keywords} \\
				\hline
				...
				7  & 0.686045 & 2.75  & water, river, waters, rain, rivers, cauca, neighborhoods, works, bogotá, country \\
...
\begin{table}[H]
	...
	\begin{tabular}{lrrr}
		\toprule
		\textbf{Verb} & \textbf{Total frequency} & \textbf{Science frequency} & \textbf{Science proportion} \\
		\midrule
...
\begin{table}[H]
	...
	\begin{tabular}{lrrr}
		\toprule
		\textbf{Adjective} & \textbf{Total frequency} & \textbf{Science frequency} & \textbf{Science proportion} \\
		\midrule
		\textit{ecosistémico} (`ecosystemic')   & 65   & 53  & 0.82 \\
		\textit{invernadero} (`greenhouse')     & 100  & 68  & 0.68 \\
		\textit{silvestre} (`wild')             & 133  & 81  & 0.61 \\
		\textit{hídrico} (`hydric')             & 107  & 65  & 0.61 \\
		\textit{forestal} (`forestry')          & 173  & 105 & 0.61 \\
		\textit{ambiental} (`environmental')    & 1530 & 910 & 0.59 \\
		\textit{climático} (`climatic')         & 984  & 584 & 0.59 \\
		\textit{renovable} (`renewable')        & 149  & 84  & 0.56 \\
		\textit{fósil} (`fossil')               & 196  & 110 & 0.56 \\
		\textit{ecológico} (`ecological')       & 322  & 180 & 0.56 \\
		\textit{científico} (`scientific')      & 959  & 507 & 0.53 \\
		\textit{energético} (`energy-related')  & 227  & 119 & 0.52 \\
		\textit{biológico} (`biological')       & 183  & 87  & 0.48 \\
...
Overall, these results suggest that, in Colombian opinion columns, science is predominantly represented from an instrumental and contextualized perspective, closely linked to critical junctures, environmental challenges, and governance processes, rather than as a set of abstract disciplines or decontextualized bodies of knowledge.
	...
	This research was supported by the internal research project “Arte, ciencia y tecnología en la esfera pública: el aporte de las Humanidades Digitales al análisis de los discursos en la esfera pública en Colombia” (Project No. 12740112024), funded through the 2024 Internal Research Projects Call (Convocatoria proyectos internos 2024 a iniciar en 2025) of Universidad EAFIT, Medellín, Colombia.
	
	\section*{Data Availability Statement}
	The data and code supporting the findings of this study are openly available in the following GitHub repository:
	https://github.com/BMSS-EAFIT-Projects/HumanidadesDigitales
	
	\section*{Acknowledgments}
	The authors gratefully acknowledge Universidad EAFIT for awarding a full scholarship to Karen for the Master’s degree in Data Science and Analytics, which supported her participation in this research.
	We also sincerely thank all members of the research project “Arte, ciencia y tecnología en la esfera pública: el aporte de las Humanidades Digitales al análisis de los discursos en la esfera pública en Colombia” for their continuous support and collaborative engagement throughout the development of this study.
	In particular, we wish to thank the interns and students who assisted in the collection and organization of the opinion columns analyzed in this article. Their dedicated work was essential to the construction of the corpus.
	We are grateful to the project team for their feedback, recommendations, and complementary ideas, which helped refine different stages of this research.
