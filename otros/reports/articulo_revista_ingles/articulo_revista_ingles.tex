...
For each estimated model, the coherence metric \textit{c\_v} was calculated, which evaluates the degree of internal semantic consistency of the most representative terms for each topic. In general terms, higher coherence values indicate that the words defining a topic tend to co-occur in the corpus, which is usually associated with greater interpretability from a human perspective. Reporting the results for different configurations allows us to compare the thematic quality of the models and justify the selection of the most appropriate number of topics. The results obtained are presented in Table~\ref{tab:coherence_topics}.
